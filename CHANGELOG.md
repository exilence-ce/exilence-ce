...
- Map prices are matched again by parsing the tier from the new "Map (Tier N)" naming, and the legacy-map filter now follows the latest map generation automatically
